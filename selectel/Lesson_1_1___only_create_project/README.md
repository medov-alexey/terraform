Lesson 1.1 - первый демонстрационный пример создания ресурсов через Terraform

Просто создаем тестовый проект в облаке Selectel, и потом удаляем его (в рамках знакомства с Terraform)
